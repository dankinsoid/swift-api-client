...
public struct HTTPResponseValidator {
	...
	public var validate: (HTTPURLResponse, Data, APIClient.Configs) throws -> Void
	...
	public init(_ validate: @escaping (HTTPURLResponse, Data, APIClient.Configs) throws -> Void) {
