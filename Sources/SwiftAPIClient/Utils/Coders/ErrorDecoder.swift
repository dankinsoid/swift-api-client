...
public struct ErrorDecoder {
	...
	public var decodeError: (Data, APIClient.Configs) -> Error?

	public init(decodeError: @escaping (Data, APIClient.Configs) -> Error?) {
...
public extension ErrorDecoder {
	...
	///   - dataDecoder: The `DataDecoder` to use for decoding. If `nil`, the `bodyDecoder` of the `APIClient.Configs` will be used.
