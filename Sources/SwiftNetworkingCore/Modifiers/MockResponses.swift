...
public extension NetworkClient {
	...
	/// - Returns: An instance of `NetworkClient` configured with the specified mock.
	///
	func mock<T>(_ value: T) -> NetworkClient {
		configs {
	...
	/// - Returns: An instance of `NetworkClient` configured with the specified mock policy.
	func usingMocks(policy: UsingMocksPolicy) -> NetworkClient {
...
public extension NetworkClient.Configs {
	...
	/// - Returns: A new `NetworkClient.Configs` instance with the specified mock.
